...
const dimensions = [
  {
    title: "Atracción",
    description: "Cómo tu negocio genera nuevas oportunidades."
  },
  {
    title: "Conversión",
    description: "Qué tan efectivo eres convirtiendo prospectos en clientes."
  },
  {
    title: "Autoridad",
    description: "El nivel de credibilidad y posicionamiento de tu marca."
  },
  {
    title: "Escalabilidad",
    description: "Qué tan preparado está tu negocio para crecer."
  }
];
      ...
      <Container className="space-y-16">
        <section className="rounded-2xl bg-gradient-to-br from-slate-900 to-brand-700 p-10 text-white shadow-soft md:p-14">
          ...
          <h1 className="max-w-2xl text-3xl font-bold leading-tight md:text-5xl">
            Diagnóstico Estratégico ACAE
          </h1>

          <p className="mt-5 max-w-2xl text-base text-slate-100 md:text-lg">
            Descubre qué está bloqueando el crecimiento de tu negocio.
          </p>
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-soft md:p-10">
          <p className="mx-auto max-w-2xl text-lg text-slate-700">
            Realiza este diagnóstico de 5 minutos y descubre el verdadero
            cuello de botella de tu negocio.
          </p>

          <Link
            href="/diagnostic"
            className="mt-6 inline-flex rounded-lg bg-brand-600 px-6 py-3 font-semibold text-white transition hover:bg-brand-700"
          >
            Iniciar Diagnóstico
          </Link>
        </section>
